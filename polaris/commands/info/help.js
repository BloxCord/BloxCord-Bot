...
class helpCommand extends BaseCommand {
	constructor (client) {
		super(client);
		this.group = 'Misc';
		this.description = "Displays help page and all of BloxCord' Commands";
	...
	assemble (prefix) {
		...
		var embed = {
			title: 'Help menu',
			description: `Listed below is all of BloxCord' commands. You can also see them on our [website](http://BloxCord.online/commands). Need more help? Join our [Discord](https://discord.gg/). Do \`${prefix}settings\` to set up the bot.`,
			fields: []
		};
		...
		embed.footer = {text: 'BloxCord bot', icon_url: this.client.user.avatarURL};
